...
public class CustomLoginHandler implements AuthenticationSuccessHandler, AuthenticationFailureHandler {
        ...
        public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
                ...
                System.out.println("디버그: 로그인이 성공하였습니다.");
        }

        // ControllerAdvice가 제어하지 못함
        @Override
        public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response,
                        AuthenticationException exception) throws IOException, ServletException {
                System.out.println("디버그: 로그인이 실패하였습니다.");
                ObjectMapper om = new ObjectMapper();
                ResponseDto<?> responseDto = new ResponseDto<>("디버그: 로그인 실패", null);
